...
save_model_folder = '/mydrive/rcnn/pytorch_model'
output_image_folder = '/content/output'
num_classes = 4  # 2 class (person) + background
batch_size = 5
num_epochs = 20
...
if __name__ == "__main__":
    ...
    dataset_train = FacialDataset('/content/KaggleFaceMaskDetection/data/train', get_transform(horizontal_flip=True))
    dataset_test = FacialDataset('/content/KaggleFaceMaskDetection/data/test', get_transform(horizontal_flip=False))
    ...
    for epoch in range(num_epochs):
        ...
        print("Saving model...")
        torch.save(model.state_dict(), os.path.join(save_model_folder, 'FaceMaskDetection_TrainEpoch_' + str(epoch) + '.pth'))
