...
output_image_folder = '/content/KaggleFaceMaskDetection/output'
...
if __name__ == "__main__":
    ...
    dataset_test = FacialDataset('/content/data_test', get_transform(horizontal_flip=False))
    ...
    model.load_state_dict(torch.load(os.path.join(save_model_folder, 'FaceMaskDetection_TrainEpoch_' + str(num_epochs) + '.pth')))
    model.to(device)
